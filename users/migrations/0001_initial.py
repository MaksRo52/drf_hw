    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, help_text='Загрузите своё фото.', null=True, upload_to='users/photos/', verbose_name='Фото')),
            ...
            options={
                ...
                'permissions': [('can_edit_is_active', 'Может блокировать пользователя'), ('can_view_users', 'Может просматривать пользователей')],
            },
            managers=[
